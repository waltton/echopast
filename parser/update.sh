#16 * * * * /opt/whatifound/update.sh >> /opt/whatifound/update.logs 2>&1
...
sed -i "s/let data.*/let data = $(psql -h logs.cqt0hiaqnebp.us-west-2.rds.amazonaws.com -U logs -At < /opt/whatifound/q1.sql)/g" /opt/whatifound/index.html
